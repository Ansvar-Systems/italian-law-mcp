...
const SERVER_NAME = 'italian-law-mcp';
...
const GITHUB_REPO = 'Ansvar-Systems/italian-law-mcp';
...
async function initializeDatabase(): Promise<void> {
  ...
  const envDb = process.env.ITALIAN_LAW_DB_PATH;
  ...
  const downloadUrl = process.env.ITALIAN_LAW_DB_URL ?? DEFAULT_RELEASE_URL;
