/**
 * get_italian_implementations — Find Italian laws implementing an EU directive/regulation.
 */
...
export interface GetItalianImplementationsResult {
  eu_document_id: string;
  eu_title?: string;
...
export async function getItalianImplementations(
  db: Database,
  input: GetItalianImplementationsInput
): Promise<ToolResponse<GetItalianImplementationsResult>> {
